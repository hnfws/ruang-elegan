...
class AdminController extends Controller
{
    public function index()
    {
        ...
        // 2. Total Semua Quotation (Karena tidak memakai status, hitung polosan semua)
        ...
        // 4. Data Dummy Grafik Lingkaran (Dibuat statis agar tampilan blade index Anda tidak error/kosong)
        ...
        // 6. Navbar Notifications (4 Quotation baru tanpa filter status)
        ...
        // 7. Data untuk Grafik Garis Penjualan (Hapus where status)
        ...
        // 8. Product Gallery & Fallback (Gunakan sub_query agar aman dari SQL Strict Mode)
        $sub_query = DB::table('detail_quotation as dq')
            ...
            // Catatan: Di-set NULL karena tabel quotation Anda tidak memiliki kolom desain/status.
        ...
        // Mengirimkan semua data di atas ke view Blade di dalam folder admin
