        ...
        <div class="col-md-12 widget-holder">
            <div class="widget-bg">
                <div class="widget-body clearfix">
                    ...
                    <form class="form-material" action="{{ route('estimator.produk.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    {{-- PERBAIKAN: Placeholder dihapus agar tidak bentrok dengan label melayang --}}
                        ...
                        <div class="form-actions btn-list mr-t-10">
                            ...
                            <a href="{{ route('estimator.produk.index') }}" class="btn btn-default btn-rounded ripple">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
