    ...
    <div id="wrapper" class="wrapper">
        ...
        <nav class="navbar">
            <div class="navbar-header">
                <a href="{{ url('/admin/index') }}" class="navbar-brand text-center">
            ...
            <aside class="site-sidebar scrollbar-enabled clearfix">
                ...
                <nav class="sidebar-nav">
                    <ul class="nav in side-menu">
                        <li class="{{ Request::is('admin/index') ? 'current-page' : '' }}">
                            <a href="{{ url('/admin/index') }}" class="ripple">
                                <i class="list-icon material-icons" style="color: #47622A;">network_check</i> 
                                <span class="hide-menu">Dashboard</span>
                            </a>
                        </li>
                        
                        <li class="{{ Request::is('admin/customer*') ? 'current-page' : '' }}">
                            <a href="{{ url('/admin/customer') }}" class="ripple">
                        ...
                        <li>
                            <a href="{{ url('/admin/staff') }}" class="ripple">
                        ...
                        <li>
                            <a href="{{ url('/admin/quotation') }}" class="ripple">
