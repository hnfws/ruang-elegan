...
<head>
    ...
    <link href="{{ asset('assets/css/perfect-scrollbar.min.css') }}" rel="stylesheet" type="text/css">
    ...
    <link href="{{ asset('assets/css/bootstrap-daterangepicker.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/morris.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/slick.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/slick-theme.min.css') }}" rel="stylesheet" type="text/css">
    <!-- Head Libs -->
...
<body class="sidebar-light sidebar-expand">
        ...
        <nav class="navbar">
            ...
            <div class="navbar-header">
                <a href="index.php" class="navbar-brand text-center">
                    ...
                    <img class="logo-collapse" alt="" src="{{ asset('assets/demo/logo-collapse.png') }}" width="60" >
                    <!-- <p>OSCAR</p> -->
                </a>
            </div>
            <!-- /.navbar-header -->
    ...
    <div class="dropdown-menu dropdown-left dropdown-card animated flipInY">
        <div class="card">
            ...
            <ul class="list-unstyled dropdown-list-group">
                @foreach($q_navbar_notif as $notif)
                    <li>
                        <a href="./quotation/index-quot.php" class="media">
                            ...
                            <span class="media-body">
                                ...
                                <small>ID: #{{ $notif->id_quotation }}</small> 
                                <span class="media-content">Pesanan milik <strong>{{ $notif->nama }}</strong> senilai Rp {{ number_format($notif->total_harga, 0, ',', '.') }} telah di-ACC.</span>
                            </span>
                        </a>
                    </li>
                    @endforeach
                        ...
                        <div class="card">
                            <header class="card-heading-extra">
                                <div class="row">
                                    ...
                                    <div class="col-4 d-flex justify-content-end"><a href="{{ url('/logout') }}" class="mr-t-10"><i class="material-icons list-icon">power_settings_new</i> Logout</a>
                                    </div>
                                    <!-- /.col-4 -->
                                </div>
                                <!-- /.row -->
        ...
        <aside class="site-sidebar scrollbar-enabled clearfix">
            ...
            <nav class="sidebar-nav">
                    <ul class="nav in side-menu">
                        ...
                        <li>
                            <a href="{{ route('admin.customer.index') }}" class="ripple">
                                <i class="list-icon material-icons" style="color: #47622A;">group</i> 
                                <span class="hide-menu">Customer</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('admin.staff.index') }}" class="ripple">
                                <i class="list-icon material-icons" style="color: #47622A;">person</i> 
                                <span class="hide-menu">Staff</span>
                            </a>
                        </li>

                        <li>
                            <a href="./quotation/index-quot.php" class="ripple">
                                <i class="list-icon material-icons" style="color: #47622A;">description</i> 
                    ...
                    <div class="col-lg-3 col-sm-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <section class="mb-5">
                                    <h3 class="m-0 sub-heading-font-family fw-300 float-left">{{ $total_produk }}</h3>
                                </section>
                                <div class="clearfix">
                    ...
                    <div class="col-lg-3 col-sm-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <section class="mb-5">
                                    <h3 class="m-0 sub-heading-font-family fw-300 float-left">{{ $total_acc }}</h3>
                                </section>
                                <div class="clearfix">
                    ...
                    <div class="col-lg-3 col-sm-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <section >
<p class="w-value"><span class="pd-r-5">Rp</span>{{ singkatNominal($total_sales) }}</p>                                <div class="clearfix">
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="row">
                                    @if($q_galeri_produk->isNotEmpty())
                                    @foreach($q_galeri_produk as $prod)
                                    <div class="col-md-4">
                                        <div class="text-center user-card">
                                            <figure class="user-card-hover-social">
                                    @if(!empty($prod->desain))
                        @php 
                            // Mengambil nama file dengan menghilangkan string "uploads/desain/"
                            $nama_file = str_replace("uploads/desain/", "", $prod->desain); 
                        @endphp
                                        <img src="{{ asset('quotation/uploads/desain/' . htmlspecialchars($nama_file)) }}" 
                                            onerror="this.src='{{ asset('assets/demo/e-commerce/1.jpg') }}';" alt="" style="width: 100%; height: 250px; object-fit: cover;">
                                    @else
                                        <img src="{{ asset('assets/demo/e-commerce/1.jpg') }}" alt="" style="width: 100%; height: 250px; object-fit: cover;">
                                    @endif
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="row">
                                    @if($q_more_produk && $q_more_produk->isNotEmpty())
            @foreach($q_more_produk as $m_prod)
                @php
...
@if($loop->iteration % 2 != 0)
                                                <figure>
                                                    <img src="{{ asset('assets/demo/e-commerce/produk_' . $m_prod->id_produk . '.jpg') }}" 
                                                        onerror="this.src='{{ asset('assets/demo/e-commerce/6.jpg') }}';" alt="">
                                                </figure>
                                            @endif

                                            <div class="user-card-details">
                                                <h4>{{ $m_prod->nama_bentuk }}</h4>
                                                <span class="user-role">Rp {{ number_format($m_prod->harga_jual, 0, ',', '.') }}</span>
                                            ...
                                            @if($loop->iteration % 2 == 0) // Item Genap ?>
                                                <figure>
                                                    <img src="{{ asset('assets/demo/e-commerce/produk_' . $m_prod->id_produk . '.jpg') }}" 
                                                        onerror="this.src='{{ asset('assets/demo/e-commerce/3.jpg') }}';" alt="">
                                                </figure>
                                            @endif
    ...
    <div class="dropdown-menu dropdown-left dropdown-card animated flipInY">
        <div class="card">
            ...
            <ul class="list-unstyled dropdown-list-group">
 @foreach($recent_quotations ?? $data ?? $quotation ?? [] as $row)
    @php $row = (array) $row; @endphp
    <tr>
        <td>#QT-{{ str_pad($row['id_quotation'], 4, '0', STR_PAD_LEFT) }}</td>
        <td>{{ $row['nama'] }}</td>
        <td>{{ date('d M Y', strtotime($row['tgl_dibuat'])) }}</td>
        <td>Rp {{ number_format($row['total_harga'], 0, ',', '.') }}</td>
        <td>
            <span class="badge {{ $row['status'] == 'acc' ? 'bg-success' : ($row['status'] == 'draft' ? 'bg-warning' : 'bg-secondary') }}">
