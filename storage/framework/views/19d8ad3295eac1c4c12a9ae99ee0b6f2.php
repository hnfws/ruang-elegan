            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <form class="form-material" method="post" action="<?php echo e(route('admin.customer.update', $customer->id_customer)); ?>">
                            <?php echo csrf_field(); ?> 
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="nama" id="l30" type="text" required value="<?php echo e(old('nama', $customer->nama)); ?>">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="no_hp" id="l31" type="text" required value="<?php echo e(old('no_hp', $customer->no_hp)); ?>">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="alamat" id="l32" type="text" required value="<?php echo e(old('alamat', $customer->alamat)); ?>">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="kota" id="l33" type="text" required value="<?php echo e(old('kota', $customer->kota)); ?>">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/pemweb 2/resources/views/admin/customer/edit.blade.php ENDPATH**/ ?>