        ...
        <aside class="site-sidebar scrollbar-enabled clearfix">
            ...
            <nav class="sidebar-nav">
                    <ul class="nav in side-menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.customer.index')); ?>" class="ripple">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.staff.index')); ?>" class="ripple">
...
</html><?php /**PATH /Applications/MAMP/htdocs/pemweb 2/resources/views/admin/index.blade.php ENDPATH**/ ?>