    ...
    <div id="wrapper" class="wrapper">
        ...
        <nav class="navbar">
            <div class="navbar-header">
                <a href="<?php echo e(url('/estimator/index')); ?>" class="navbar-brand text-center">
            ...
            <aside class="site-sidebar scrollbar-enabled clearfix">
                ...
                <nav class="sidebar-nav">
                    <ul class="nav in side-menu">
                        <li class="<?php echo e(Request::is('estimator/index') ? 'current-page' : ''); ?>">
                            <a href="<?php echo e(url('/estimator/index')); ?>" class="ripple">
       ...
       <li>
                            <a href="<?php echo e(url('/estimator/bahan-baku')); ?>" class="ripple">
...
</html><?php /**PATH /Applications/MAMP/htdocs/pemweb 2/resources/views/estimator/layouts/app.blade.php ENDPATH**/ ?>