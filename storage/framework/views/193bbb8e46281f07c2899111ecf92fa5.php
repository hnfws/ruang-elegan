...
<head>
    <meta charset="UTF-8">
    <title>QUOTATION - #PRD-<?php echo e($produk->id_produk); ?></title>
    <style>
        :root {
            --terracotta: #d35400;
            --peach-bg: #fff5ee;
...
<body>
    ...
    <div class="quotation-box">
            ...
            <tr>
                <td class="brand-section">
                    <a href="<?php echo e(url('/')); ?>" style="text-decoration: none;">
                        <img alt="Logo Ruang Elegan" src="<?php echo e(asset('assets/demo/logo-expand.png')); ?>" style="width: 200px; height: auto; display: block; margin-bottom: 5px;">
                    </a>
                ...
                <td class="doc-meta">
                    <table>
                        <tr>
                            ...
                            <td>: #PRD-<?php echo e($produk->id_produk); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>: <span style="color: #27ae60; font-weight: bold; text-transform: uppercase;"><?php echo e($produk->status); ?></span></td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <div class="greeting">
            Dengan hormat,<br>
            Berikut adalah rincian rincian struktur komponen bahan baku beserta kalkulasi nilai jual akhir untuk bentuk produk <strong>"<?php echo e($produk->nama_bentuk); ?>"</strong>:
        </div>
        ...
        <table class="items-table">
            ...
            <tbody>
                <?php $__currentLoopData = $bahan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="text-center" style="vertical-align: middle;"><?php echo e($index + 1); ?></td>
                    <td class="item-desc">
                        <strong><?php echo e($b->nama_bahan); ?></strong>
                    </td>
                ...
                <tr>
                    ...
                    <td class="text-center" style="border: none; font-weight: 600; color: #7f8c8d; vertical-align: middle; padding-top: 30px;">
                        Rp <?php echo e(number_format($total_hpp_bahan, 0, ',', '.')); ?>
                ...
                <tr>
                    ...
                    <td class="text-center" style="border: none; font-weight: 600; color: var(--terracotta); vertical-align: middle;">
                        x <?php echo e(number_format($produk->faktor_kesulitan, 2)); ?>
                ...
                <tr>
                    ...
                    <td class="text-center" style="border: none; vertical-align: middle;">
                        <div class="total-box" style="min-width: 100%;">Rp <?php echo e(number_format($produk->harga_jual, 0, ',', '.')); ?></div>
                    </td>
                </tr>
            </tbody>
        </table>
...
</html><?php /**PATH /Applications/MAMP/htdocs/pemweb 2/resources/views/estimator/produk/final_save.blade.php ENDPATH**/ ?>