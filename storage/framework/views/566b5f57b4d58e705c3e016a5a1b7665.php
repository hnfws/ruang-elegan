...
<?php $__env->startSection('title', 'Edit Bahan Baku'); ?>
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <form class="form-material" action="<?php echo e(route('estimator.bahanbaku.update', $bahan->id_bahanbaku)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="nama_bahan" id="l30" type="text" value="<?php echo e($bahan->nama_bahan); ?>" required>
                                                <label for="l30">Nama Bahan</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input class="form-control" name="merk" id="l31" type="text" value="<?php echo e($bahan->merk); ?>" required>
                                                <label for="l31">Merk</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input class="form-control" name="jenis" id="l32" type="text" value="<?php echo e($bahan->jenis); ?>" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="satuan" id="l34" required>
                                                    ...
                                                    <?php $__currentLoopData = $satuan_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan_option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                                        <option value="<?php echo e($satuan_option); ?>" <?php echo e($bahan->satuan == $satuan_option ? 'selected' : ''); ?>>
                                                            <?php echo e($satuan_option); ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input class="form-control" name="tebal_mm" id="l35" type="number" step="0.01" value="<?php echo e($bahan->tebal_mm); ?>" required>
...
<?php echo $__env->make('estimator.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/pemweb 2/resources/views/estimator/bahanbaku/edit.blade.php ENDPATH**/ ?>