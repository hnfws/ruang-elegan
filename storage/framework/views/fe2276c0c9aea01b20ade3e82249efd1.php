...
<head>
    <meta charset="UTF-8">
    <title>QUOTATION - #QUO-<?php echo e($id_quotation); ?></title>
    <style>
        :root {
            --terracotta: #d35400;
            --peach-bg: #fff5ee;
            ...
            <tr>
                <td>
                    <div class="client-info">
                        ...
                        <div><?php echo e($quot['nama_customer']); ?></div>
                        <div style="font-weight: normal; font-size: 13px; color: var(--text-muted); margin-top: 5px;">
                            <?php echo nl2br(e($quot['alamat_customer'] ?? 'Alamat belum diatur')); ?><br>
                            Telp: <?php echo e($quot['telp_customer'] ?? '-'); ?>
                ...
                <td class="doc-meta">
                    <table>
                        <tr>
                            ...
                            <td>: #QUO-<?php echo e($id_quotation); ?></td>
                        </tr>
                        <tr>
                            <td class="label">Tanggal</td>
                            <td>: <?php echo e(date('d F Y', strtotime($quot['tgl_dibuat']))); ?></td>
                        </tr>
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($item['nama_bentuk'] ?? 'Produk Custom / Telah Dihapus'); ?></td>
                        <td class="text-center" style="vertical-align: middle; font-weight: 600;">
                            <?php echo e(floatval($item['qty'])); ?>

                        </td>
                        <td class="text-right" style="vertical-align: middle;">
                            <?php echo e(floatval($item['harga_satuan'])); ?>

                        </td>
                        <td class="text-right fw-bold" style="vertical-align: middle; color: var(--text-dark);">
                            <?php echo e(floatval($item['subtotal'])); ?>
                ...
                <tr>
                    ...
                    <td class="text-right" style="border: none;">
                        <div class="total-box"><?php echo e(floatval($quot['total_harga'])); ?></div>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="footer-section">
            <tr>
                <td>
                    ...
                    <div class="fw-bold"><?php echo e($quot['nama_customer']); ?></div>
...
</html><?php /**PATH /Applications/MAMP/htdocs/pemweb 2/resources/views/admin/quotation/print.blade.php ENDPATH**/ ?>